    ...
    <div className="min-h-screen flex bg-gradient-to-br from-slate-50 via-white to-emerald-50/50">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        ...
        <div className="w-full max-w-md relative">
          ...
          <div className="mt-10 p-5 bg-gradient-to-r from-emerald-50/80 via-green-50/80 to-teal-50/80 rounded-2xl border border-emerald-100/50 shadow-sm backdrop-blur-sm">
